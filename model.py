...
class GNNwithCNN(nn.Module):
    ...
    def __init__(self, hidden_dim=256, output=1):
        ...
        self.cnn_conv0_1 = nn.Sequential(nn.Conv2d(2,16,(1,1)), self.bn1, nn.ReLU())
        ...
        self.cnn_conv0_2 = nn.Sequential(nn.Conv2d(16,32,(1,1)), self.bn4, nn.ReLU())
        ...
        self.cnn_conv0_3 = nn.Sequential(nn.Conv2d(32,64,(1,1)), self.bn7, nn.ReLU())
        ...
        self.cnn_conv0_4 = nn.Sequential(nn.Conv2d(64,128,(1,1)), self.bn10, nn.ReLU())
        ...
        self.cnn_conv0_5 = nn.Sequential(nn.Conv2d(128,256,(1,1)), self.bn13, nn.ReLU())
        ...
        self.out_layer1 = MLPLayer(hidden_dim * 2, hidden_dim)
        self.out_layer2 = MLPLayer(hidden_dim, output)
        
    def forward(self, basegnn, g, total_map):
        g = g.local_var()
        topo_features = basegnn(g)
...
class WaveFunctionModel(nn.Module):
    #for VB  /  CB  descriptor ,wavefunction depiction
